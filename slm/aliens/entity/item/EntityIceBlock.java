...
public class EntityIce extends Entity {
	
    /** How long the fuse is */
    public int fuse;
    private EntityLivingBase ice;
    private static final String __OBFID = "CL_00001681";

    public EntityIce(World p_i1729_1_) {
        super(p_i1729_1_);
    ...
    public EntityIce(World p_i1730_1_, double p_i1730_2_, double p_i1730_4_, double p_i1730_6_, EntityLivingBase p_i1730_8_) {
        this(p_i1730_1_);
